...
let otp_type = localStorage.getItem('otp_type');
otp_verification_form.addEventListener("submit", OTPverification);
        ...
        response.json().then(function(res) {
            if (response.status == 200) {
                ...
                setTimeout(() => {
                    ...
                    location.pathname = otp_type == 'forgot' ? "/user-reset-password/" : "/user-signup/";
                }, 1500)
            }
            else {
                afterLoad(button, buttonText);
